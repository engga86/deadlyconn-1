...
const referProgCB = document.querySelectorAll(
  'input[name="progRefMiscInfo"]:checked'
);
let selectReferProgCB = []; //Array for holding the checked values
referProgCB.forEach((checkbox) => {
  selectReferProgCB.push(checkbox.value);
});
...
let childInfoDCJCaseWorker = document.getElementById(
  "DCJCaseworker/Office/Contact"
);
let childInfoRefReason = document.getElementById("referralReasons");

// -- Section 5 related --
const section5 = document.querySelectorAll(
  'input[name="supportNeeds"]:checked'
);
let childAddInfo = []; //Array for storing selected values
section5.forEach((checkbox) => {
  childAddInfo.push(checkbox.value);
});
...
const orderUponReleaseRB = document.querySelectorAll(
  'input[name="OrderUponRelease"]'
);
...
// -- Section 7 related --
const riskFactorADVORB = document.querySelectorAll(
  'input[name="riskFactorADVO"]'
);
...
// -- Section 8 related --
const agencySupportRB = document.querySelectorAll(
  'input[name="OtherAgencies"]'
);
...
const previousClientRB = document.querySelectorAll(
  'input[name="previousClient"]'
);
...
const eligibleCriteriaRB = document.querySelectorAll(
  'input[name="meetsEligibility"]'
);
...
const inCatchmentAreaRB = document.querySelectorAll(
  'input[name="inCatchment"]'
);
...
const clientAcceptedRB = document.querySelectorAll(
  'input[name="clientAccepted"]'
);
...
const nominatedPersonNotified = document.querySelectorAll(
  'input[name="notifyNominatedPerson"]'
);
let nominPersNotify;
for (const nomPersNotify of nominatedPersonNotified) {
  if (nomPersNotify.checked) {
    ...
    nominPersNotify = "Nominated person not notified";
  }
}

const notAcceptedClientRB = document.querySelectorAll(
  'input[name="notAcceptedClient"]'
);
...
let reasonsForNonAcceptance = document.getElementById(
  "notAcceptedClientReasons"
);
let furtherReasonNonAcceptance = document.getElementById(
  "furtherReasonNonAccept"
);

const followupReferrer = document.querySelectorAll(
  'input[name="followupWithReferrer"]'
);
let followUpRef;
for (const followup of followupReferrer) {
  if (followup.checked) {
    ...
    followUpRef = "Not followed up with Referrer";
  }
}
...
newRefFormButton.addEventListener("click", (e) => {
  e.preventDefault();
});
...
editSavBtn.addEventListener("click", (e) => {
  e.preventDefault();
});
